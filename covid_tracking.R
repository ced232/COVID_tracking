...
confirmed_data <- read.csv("confirmed_2020_12_17.csv", stringsAsFactors = FALSE)  %>%
...
deaths_data <- read.csv("deaths_2020_12_17.csv", stringsAsFactors = FALSE) %>%
    filter(!(Province_State %in% c("American Samoa", "Diamond Princess", "Grand Princess", "Guam", 
                                   "Northern Mariana Islands", "Puerto Rico", "Virgin Islands"))) %>%
